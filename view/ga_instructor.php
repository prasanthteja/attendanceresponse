						...
						<div class="col-md-12">	
							...
							<div class="course-info">
								...
								<div class = "course-link">
									...
									<?php
										if($final_course_details[$i][10] != "GA")
										{
									?>
											<a class="btn btn-success" href= "https://www.wiu.edu/citr/AttendanceResponsive/index.sphp?action=addGA&starnumber=<?php echo $final_course_details[$i][2]; ?>">Add GA</a>
											<a class="btn btn-success" href= "https://www.wiu.edu/citr/AttendanceResponsive/index.sphp?action=addNote&starnumber=<?php echo $final_course_details[$i][2]; ?>" >Add Student Note</a>
											<a class="btn btn-success" href= "https://www.wiu.edu/citr/AttendanceTracking/functions/dashboard.function.course.sphp?subjectId=<?php echo $final_course_details[$i][2]; ?>" target = "_blank" >Dashboard</a>
									<?php
										}
									?>
